  ...
  return(
    <div class={`${styles.container} ${styles.cp}`}>
       <h4 class={styles.title}>{obj.title}</h4>
        ...
        {obj.aforo && (<p><span class={styles.bold}>Publico:</span> {obj.aforo}</p>)}
    ...
    return(
      <div class={styles.container}>
        <ul>
          ...
          <li id="music" class={styles.proyecto} onclick={open_Music}>Explorações Musicais <span class={styles.type}>Música</span> / 2021-2023</li>
          {showMusic() && <Sonido obj={soundapi.exploracionesmusicales}/>}

          <li id="paisajesonoros" class={styles.proyecto} onclick={open_PaisajesSonoros}>Paisagens Sonoras <span class={styles.type}>Som</span> / 2019-2022</li>
          ...
          <li id="abyayala" class={styles.proyecto} onclick={open_AbyaYala}>Sons experimentais do Abya Yala <span class={styles.type}>Performance Sonora</span> / 2018</li>
          {showAbyaYala() && (<Sonido obj={soundapi.abyayalasounds} />)}
          
          <li id="djselector" class={styles.proyecto} onclick={open_DjSelector}>DJ Selector / 2009-2026</li>
